...
def svd_to_yaml(svd_file_path, yaml_file_path):
    # 解析SVD文件
    ...
    for peripheral in root.findall('.//peripheral'):
        ...
        peripherals.append(peripheral_dict)

    # 将数据写入YAML文件
    with open(yaml_file_path, 'w') as yaml_file:
        yaml.dump({'peripherals': peripherals}, yaml_file, default_flow_style=False)
...
svd_to_yaml(svd_file, yaml_file)