...
def main():
    ...
    # use svd file to yml (gqz)
    # parser_emu.add_argument("--default_yml", type=str, default="false",
    #                     help="Whether to use the default configuration file")
    # parser_emu.add_argument("--svd_path", type=str, default="", help="svd file path")
